...
{
	/// <summary>
	/// Description of fix_problem_in_mentor.
	/// </summary>
	public partial class fix_problem_in_mentor : Form
	{
		public fix_problem_in_mentor(string filter_string)
		{
			//
			...
			bind_mentor.Filter = filter_string;
		}
		
		List<DataRow> kill_they = new List<DataRow>();
		void DataGridView_mentorCellValueChanged(object sender, DataGridViewCellEventArgs e)
		{
		...
		void DataGridView_mentorCellBeginEdit(object sender, DataGridViewCellCancelEventArgs e)
		{
			if(e.ColumnIndex!=-1 && e.RowIndex!=-1)
			{
				changed_row = ((DataRowView)bind_mentor.List[e.RowIndex]).Row;
				wasChanged = true;
			}
		}
		...
		void Fix_problem_in_mentorLoad(object sender, EventArgs e)
		{
