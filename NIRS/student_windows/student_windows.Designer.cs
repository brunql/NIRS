...
namespace NIRS
{
	partial class student_windows
	{
		...
		private void InitializeComponent()
		{
			...
			this.contextMenuStrip_student.Size = new System.Drawing.Size(228, 26);
			// 
			...
			this.mentoridDataGridViewTextBoxColumn.HeaderText = "Руководители";
			this.mentoridDataGridViewTextBoxColumn.Name = "mentoridDataGridViewTextBoxColumn";
			this.mentoridDataGridViewTextBoxColumn.ToolTipText = "научные руководители студента";
			// 
