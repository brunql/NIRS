...
namespace NIRS {
    ...
    public partial class nirsDataSetMain : global::System.Data.DataSet {
        ...
        public partial class studentDataTable : global::System.Data.TypedTableBase<studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public studentRow AddstudentRow(string name, string surname, string fathername, int group_id, int mentor_id, System.DateTime born) {
        ...
        public partial class studentRow : global::System.Data.DataRow {
            ...
            public int mentor_id {
                get {
                    return ((int)(this[this.tablestudent.mentor_idColumn]));
                }
                set {
                    this[this.tablestudent.mentor_idColumn] = value;
                }
            }
...
namespace NIRS.nirsDataSetMainTableAdapters {
    ...
    public partial class divisionTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::NIRS.Properties.Settings.Default.nirsConnectionStringMain;
        }
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `nirs`.`student` WHERE ((`id` = @Original_id) AND (`name` = @Original_name) AND (`surname` = @Original_surname) AND (`fathername` = @Original_fathername) AND (`group_id` = @Original_group_id) AND (`mentor_id` = @Original_mentor_id) AND (`born` = @Original_born))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            global::MySql.Data.MySqlClient.MySqlParameter param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@Original_id";
            param.DbType = global::System.Data.DbType.Int32;
            ...
            this._adapter.InsertCommand = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `nirs`.`student` (`name`, `surname`, `fathername`, `group_id`, `mento" +
                "r_id`, `born`) VALUES (@name, @surname, @fathername, @group_id, @mentor_id, @bor" +
                "n)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@name";
            ...
            this._adapter.UpdateCommand = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE `nirs`.`student` SET `name` = @name, `surname` = @surname, `fathername` = @fathername, `group_id` = @group_id, `mentor_id` = @mentor_id, `born` = @born WHERE ((`id` = @Original_id) AND (`name` = @Original_name) AND (`surname` = @Original_surname) AND (`fathername` = @Original_fathername) AND (`group_id` = @Original_group_id) AND (`mentor_id` = @Original_mentor_id) AND (`born` = @Original_born))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@name";
            param.DbType = global::System.Data.DbType.String;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT `id`, `name`, `surname`, `fathername`, `group_id`, `mentor_id`, `born` FRO" +
                "M `nirs`.`student`";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_id, string Original_name, string Original_surname, string Original_fathername, int Original_group_id, int Original_mentor_id, System.DateTime Original_born) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_id));
            if ((Original_name == null)) {
                throw new global::System.ArgumentNullException("Original_name");
            }
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_mentor_id));
            this.Adapter.DeleteCommand.Parameters[6].Value = ((System.DateTime)(Original_born));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.DeleteCommand.Connection.State;
            if (((this.Adapter.DeleteCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.DeleteCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string name, string surname, string fathername, int group_id, int mentor_id, System.DateTime born) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(mentor_id));
            this.Adapter.InsertCommand.Parameters[5].Value = ((System.DateTime)(born));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.InsertCommand.Connection.State;
            if (((this.Adapter.InsertCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.InsertCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string surname, string fathername, int group_id, int mentor_id, System.DateTime born, int Original_id, string Original_name, string Original_surname, string Original_fathername, int Original_group_id, int Original_mentor_id, System.DateTime Original_born) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(mentor_id));
            this.Adapter.UpdateCommand.Parameters[5].Value = ((System.DateTime)(born));
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_group_id));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(Original_mentor_id));
    ...
    public partial class worksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT id, student_id, name, `desc`, mentor_id FROM works";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_id, int Original_student_id, string Original_name, uint Original_mentor_id) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_id));
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((uint)(Original_mentor_id));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.DeleteCommand.Connection.State;
            if (((this.Adapter.DeleteCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.DeleteCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int student_id, string name, string desc, uint mentor_id) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((uint)(mentor_id));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.InsertCommand.Connection.State;
            if (((this.Adapter.InsertCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.InsertCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int student_id, string name, string desc, uint mentor_id, int Original_id, int Original_student_id, string Original_name, uint Original_mentor_id) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((uint)(mentor_id));
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((uint)(Original_mentor_id));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
