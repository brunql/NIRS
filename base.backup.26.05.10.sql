...
INSERT INTO `student` VALUES (1,'Василий','Иванов','Петрович',8,'1990-11-12','Бюджет','Стипендия Dr.Web','test@mail.ru','8-903-455-55-55'),(2,'Евгений','Смертин','Николаевич',8,'1990-03-11','СКЦ','нет','',''),(7,'Николай','Безбедов','Владимирович',13,'1991-01-01','Бюджет','Стипендия Microsoft','',''),(8,'Юлия','Молчанова','Петровна',10,'2003-03-02','Бюджет','Нет','',''),(9,'Генадий','Сидоров','Викторович',14,'1993-02-02','СКЦ','Нет','',''),(10,'test','test','test',6,'1991-04-10','СКЦ','Нет','test@test.ru','test'),(11,'as','aa','dd',8,'1999-04-10','СКЦ','Нет','test','testttt');
UNLOCK TABLES;
